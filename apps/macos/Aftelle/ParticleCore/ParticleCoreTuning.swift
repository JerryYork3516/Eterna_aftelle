...
struct ParticleCoreTuning: Codable, Equatable {
    ...
    static let systemDefault = ParticleCoreTuning(
        ...
        membraneFullness: 0.80,
        sheetLightStrength: 0.62,
        flowLightStrength: 0.62,
        spineLineStrength: 0.46,
        spineLineWidth: 0.46,
        spineLineDensity: 0.45,
        spineLineHighlight: 0.48,
        spineLineContrast: 0.47,
        spineLineSharpness: 0.44,
        edgeDustAmount: 0.30,
        edgeFrayAmount: 0.30,
        surfaceDispersionStrength: 0.28,
