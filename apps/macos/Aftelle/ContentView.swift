...
private enum ParticleTuningGroup: CaseIterable, Identifiable {
    ...
    var parameters: [ParticleCoreTuningParameter] {
        ...
        case .shape:
            return [.targetShapeStrength, .targetShapeRadius, .shapeSeed, .surfaceReliefStrength, .shapeScaleX, .shapeScaleY, .shapeScaleZ]
        case .surface:
                        ...
                        VStack(spacing: 8) {
                            ...
                            VStack(spacing: 10) {
                                ForEach(tuningGroup.parameters) { parameter in
                                    if parameter == .rotationDirection || parameter == .lightRotationDirection {
...
private struct ParticleDirectionRow: View {
    ...
    private var isDefault: Bool {
        abs(tuning[keyPath: parameter.keyPath] - parameter.defaultValue) < 0.0005
    }
